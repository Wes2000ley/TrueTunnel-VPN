...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
   ...
   // io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;       // Enable Multi-Viewport / Platform Windows
    ...
    // Optional: high-contrast style colors
    ...
    colors[ImGuiCol_HeaderActive]       = ImVec4(0.27f, 0.29f, 0.32f, 1.00f);

    // Buttons
    colors[ImGuiCol_Button]             = ImVec4(0.18f, 0.20f, 0.22f, 1.00f);
    colors[ImGuiCol_ButtonHovered]      = ImVec4(0.28f, 0.30f, 0.33f, 1.00f);
    ...
    // Borders
    colors[ImGuiCol_Border]             = ImVec4(0.22f, 0.23f, 0.25f, 0.60f);
